...
from XAE.model import SSWAE_HSIC_dev2_2
from XAE.logging_daily import logging_daily
from XAE.sampler import multinomial
from XAE.util import inc_avg, init_params, prob_mixture_enc, prob_gauss_mix

class SSWAE_HSIC_MNIST(SSWAE_HSIC_dev2_2):
    def __init__(self, cfg, log, device = 'cpu', verbose = 1):
        ...
        self.gm = prob_gauss_mix(len(self.labeled_class) + self.unk, self.y_dim).to(device)
